...
def wav_to_Ht_Hf(folder_path):
    ...
    for filename in os.listdir(folder_path):
        ...
        # Get a spectrogram to use as the input to the acoustic_complexity_index function
...
plt.title('Accuracy Comparison Acoustic Complexity Index (ACI)')
plt.xlabel('Method')
plt.ylabel('Accuracy')
plt.ylim(0, 1)
...
plt.savefig('images/ACI_SVM_RF_Graph.png')
plt.show()
